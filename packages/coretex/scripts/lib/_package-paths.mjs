/**
 * Path resolution for the runtime scripts SHIPPED INSIDE the @botcoin/coretex
 * package (packages/coretex/scripts/). Counterpart of the repo-level
 * scripts/_repo-root.mjs, but it must work in BOTH layouts:
 *
 *   1. repo checkout:        <repo>/packages/coretex/scripts/lib/_package-paths.mjs
 *   2. node_modules install: <proj>/node_modules/@botcoin/coretex/scripts/lib/_package-paths.mjs
 *
...
const here = dirname(fileURLToPath(import.meta.url)); // packages/coretex/scripts/lib
