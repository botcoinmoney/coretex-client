...
const REPO_ROOT = '/root/coretex'; // tests run with package CWD; unused by validateProfile
...
describe('DEFAULT_BASE_RPC_CONFIG', () => {
  test('is exported and has Base mainnet values', () => {
    ...
    assert.equal(DEFAULT_BASE_RPC_CONFIG.targetBlockOffset, 15, 'default offset ≈ 30 s on Base');
